package maharshkumar.raval.n01391355;
...
public class MaharshkumarActivity1 extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(uName.equalsIgnoreCase(firstName)){
                    // to second act
                    Toast.makeText(MaharshkumarActivity1.this, "working", Toast.LENGTH_SHORT).show();
                }else{
                    createAlertDialog();
                }
    ...
    private void createAlertDialog(){
        ...
        builder.setIcon(R.drawable.lion);
